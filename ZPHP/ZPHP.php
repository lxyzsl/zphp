...
class ZPHP
{
     ...
     * @var string
     */
    private static $configPath = 'control';
    ...
    public static function getConfigPath()
    {
        ...
        return self::getRootPath() . DS . 'config' . DS . 'control';
    }
    ...
    final public static function autoLoader($class)
    {
        ...
        if (is_array(self::$libPath)) {
            foreach(self::$libPath as $libItem){
                $libs[] = self::$rootPath . DS . $libItem;
            }
        } else {
            $libs[] = self::$libPath;
        }
...
//                echo $classpath.PHP_EOL;
    ...
    public static function run($rootPath, $run = true, $configPath = null)
    {
        ...
        self::setAppPath(Config::get('app_path', self::$appPath));
