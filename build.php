<?php
    ...
    if(ZPHP\Common\Dir::make($app_path)) {
        $dirList = array(
            ...
            'config'.DIRECTORY_SEPARATOR.'control',
...
';
		file_put_contents($app_path.DIRECTORY_SEPARATOR.'config'.DIRECTORY_SEPARATOR.'control'.DIRECTORY_SEPARATOR.'config.php', $configTxt);
